...
const createPcServicesFromDb = (PCData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSinglePcFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield pc_model_1.PC.findById(id);
    return result;
});
const getByCategoryFromDb = (category) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield pc_model_1.PC.find({ category: category });
    return result;
});
const deletePCFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
