...
const productCart_model_1 = require("./productCart.model");
const createCart = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield productCart_service_1.CartService.createCart(CartData);
    if (result) {
...
const getCart = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield productCart_model_1.Cart.findOne(queryData).populate('productName');
    if (result) {
        (0, sendResponse_1.default)(res, {
            statusCode: 200,
            success: true,
